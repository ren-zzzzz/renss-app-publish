...
if [[ "$arch" == "aarch64" ]]; then
    echo "ARM (aarch64)"
    wget -N https://github.com/ren-zzzzz/renss-app-publish/releases/download/v2.1/go-remote-linux-arm64.zip && unzip go-remote-linux-arm64 && chmod +x remote
elif [[ "$arch" == "x86_64" ]]; then
    echo "x86_64"
    wget -N https://github.com/ren-zzzzz/renss-app-publish/releases/download/v2.1/go-remote-linux-amd64.zip && unzip go-remote-linux-amd64 && chmod +x remote
else
